...
newnode.tiles[2].name = "underworlds_water_poison_source_animated.png"
newnode.damage_per_second = 2
...
newnode.special_tiles[2].name = "underworlds_water_poison_flowing_animated.png"
newnode.damage_per_second = 2
...
newnode.tiles[1].name = "underworlds_water_death_source_animated.png"
newnode.tiles[2].name = "underworlds_water_death_source_animated.png"
...
newnode.liquid_alternative_source = "underworlds:water_death_source"
newnode.post_effect_color = {a = 103, r = 128, g = 108, b = 64}
newnode.tiles = {"underworlds_water_death.png"}
newnode.special_tiles[1].name = "underworlds_water_death_flowing_animated.png"
newnode.special_tiles[2].name = "underworlds_water_death_flowing_animated.png"
newnode.damage_per_second = 4 * 2
